...
ico=pygame.image.load('assets\icon1.jpg')
icon=pygame.transform.scale(ico,(32,32))
pygame.display.set_icon(icon)

# over here get the player 1 name

pygame.display.set_caption(data['player1'])
host1 = '127.0.0.10'
...
def abc(first,second,third,fourth,fifth,sixth,seventh,eighth,nineth):
        ...
        win2 = pygame.image.load('assets\win2.png')
        draw = pygame.image.load('assets\draw.png')
        # update the content of the entire screen afte every game result
        pygame.display.flip()
        while 1:
            d+=1
            ...
            while 1:              
                ...
                if event.type==pygame.MOUSEBUTTONUP:
                        ...
                        if first.collidepoint(pos):  # return true or False
                            screen.blit(cross,[1,1]) # draw cross or circle over the rectangle boxes
                            s1=1
